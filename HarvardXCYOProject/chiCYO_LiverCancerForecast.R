...
pkg <- c("caret", "tidyverse", "knitr",  "styler", "broom", "data.table", "dplyr",  "ggplot2", 
         "gghighlight", "kableExtra", "pagedown", "readr",  "stringr", "scales", "gridExtra", 
          "tseries", "lubridate", "formattable", "smooth", "ggfortify")
...
library(knitr)        # for kable, lightweight API's designed to give users full control of the output without heavy coding work.
library(tidyverse)
