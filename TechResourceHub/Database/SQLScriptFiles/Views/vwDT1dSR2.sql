...
/****** Object:  View [dbo].[vwDT1dSR]    Script Date: 12/7/2015 8:21:42 AM ******/
SET ANSI_NULLS ON
GO
...
AS
 /* 
  ...
  12/07/2015 Chi         Modified the view by omitting SRCat table and changing fy from 2013 to 2014 in query
