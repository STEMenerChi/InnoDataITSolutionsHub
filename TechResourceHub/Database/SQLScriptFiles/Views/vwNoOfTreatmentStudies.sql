...
/****** Object:  View [dbo].[vwNoOfTreatmentStudies]    Script Date: 04/18/2013 09:46:42 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[vwNoOfTreatmentStudies]
AS
/*
April 15, 2013
Requested by Linda
...
SELECT  c.InstitutionName, 
        d.StudySourceCode, COUNT(*) as NoOfTrials
FROM    DT4 d,
        Center c
WHERE   FY = 2011
...
--ORDER by d.StudySourceCode,  NoOfTrials DESC
