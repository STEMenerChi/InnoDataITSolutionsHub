...
/****** Object:  View [dbo].[vwDT1dSR]    Script Date: 3/22/2015 10:15:01 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT TOP 1000 c.InstitutionName,
			SRCat = 
				CASE S.SRCatID
			 ...
			 l.LastName + ', ' + l.FirstName AS FullName2,
			 --l2.LastName + ', ' + l2.FirstName AS FullName3, 
			 d.DT1dSRID
		FROM   DT1dSR d 
		       LEFT OUTER JOIN MultiLeader l on d.DT1dSRID = l.DT1dSRID,
			   --LEFT OUTER JOIN MultiLeader l2 on l.MultiLeaderID = l2.MultiLeaderID,
			   Center c, 
			   [SRCat] s
		WHERE  d.fy = 2013	
...
ORDER BY c.InstitutionName, S.SRCatID, d.SRName, d.LastName,  d.FirstName, L.LastName,  L.FirstName, d.DT1dSRID;
