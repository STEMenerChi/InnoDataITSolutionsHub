...
/****** Object:  View [dbo].[vwDT1dSR]    Script Date: 3/25/2015 4:49:45 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT c.InstitutionName,	   
			CASE S.SRCatID
			 ...
			 END AS SRcat, 
			 d.SRName,
			 d.LastName + ', ' + d.FirstName AS FullName1,
		...
		AND    d.isActive = 1
		AND    d.cat = s.SRCatID   		
GROUP by  c.InstitutionName, S.SRCatID, d.SRName, d.LastName, d.FirstName,  l.LastName, l.FirstName
