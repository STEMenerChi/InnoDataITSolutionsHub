...
CREATE VIEW [dbo].[vwInterventionalStudies]
AS
	
/*
 Date				Desc
 May 16, 2012	    Created
 09/06/2013         Updated sum4 to dt4 and added the centerp12 & othp12 calculations.
 
 Report Name: Intervetnional Trials by Catergoy and Center (for CTRP)
